        ...
        "filters": [
            [
                ...
                [
                    ...
                    "Bank Transaction-orion_txn_hash",
                    "Bank Transaction-orion_job",
                    "Purchase Order-orion_po_type",
                    "Purchase Order-orion_marketplace",
                    "Purchase Order-orion_online_order_id",
                    "Purchase Order-orion_status",
                    "Purchase Order-orion_received_date",
                    "Purchase Order-orion_cancelled_date",
                    "Purchase Order-orion_cancel_reason",
                    "Purchase Order-orion_notes",
                    "Purchase Order-orion_legacy_id",
                    "Purchase Order Item-orion_unit",
                    "Purchase Order Item-orion_notes",
                    "Lead-orion_client_salutation",
                    "Lead-orion_client_address",
                    "Lead-orion_source",
                    ...
                    "Customer-orion_address",
                    "Customer-orion_notes",
                ],
            ]
        ],
    },
